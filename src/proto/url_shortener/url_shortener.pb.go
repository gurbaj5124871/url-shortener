...
type GetDestinationURLFromShortURLRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetDestinationURLFromShortURLRequest) Reset() {
	*x = GetDestinationURLFromShortURLRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetDestinationURLFromShortURLRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDestinationURLFromShortURLRequest) ProtoMessage() {}

func (x *GetDestinationURLFromShortURLRequest) ProtoReflect() protoreflect.Message {
	mi := &file_url_shortener_url_shortener_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDestinationURLFromShortURLRequest.ProtoReflect.Descriptor instead.
func (*GetDestinationURLFromShortURLRequest) Descriptor() ([]byte, []int) {
	return file_url_shortener_url_shortener_proto_rawDescGZIP(), []int{3}
}

func (x *GetDestinationURLFromShortURLRequest) GetShortURL() string {
	if x != nil {
		return x.ShortURL
	}
	return ""
...
type GetDestinationURLFromShortURLResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetDestinationURLFromShortURLResponse) Reset() {
	*x = GetDestinationURLFromShortURLResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_url_shortener_url_shortener_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetDestinationURLFromShortURLResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDestinationURLFromShortURLResponse) ProtoMessage() {}

func (x *GetDestinationURLFromShortURLResponse) ProtoReflect() protoreflect.Message {
	mi := &file_url_shortener_url_shortener_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDestinationURLFromShortURLResponse.ProtoReflect.Descriptor instead.
func (*GetDestinationURLFromShortURLResponse) Descriptor() ([]byte, []int) {
	return file_url_shortener_url_shortener_proto_rawDescGZIP(), []int{4}
}

func (x *GetDestinationURLFromShortURLResponse) GetDestinationURL() string {
	if x != nil {
		return x.DestinationURL
	}
	return ""
...
var file_url_shortener_url_shortener_proto_rawDesc = []byte{
	...
	0x74, 0x55, 0x72, 0x6c, 0x44, 0x54, 0x4f, 0x52, 0x03, 0x55, 0x52, 0x4c, 0x22, 0x42, 0x0a, 0x24,
	0x47, 0x65, 0x74, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x52,
	0x4c, 0x46, 0x72, 0x6f, 0x6d, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x71,
	...
	0x22, 0x4f, 0x0a, 0x25, 0x47, 0x65, 0x74, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x55, 0x52, 0x4c, 0x46, 0x72, 0x6f, 0x6d, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x55, 0x52,
	0x4c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x26, 0x0a, 0x0e, 0x64, 0x65, 0x73,
	0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x52, 0x4c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0e, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x52,
	0x4c, 0x32, 0x85, 0x02, 0x0a, 0x13, 0x55, 0x72, 0x6c, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e,
	...
	,
...
var file_url_shortener_url_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_url_shortener_url_shortener_proto_goTypes = []interface{}{
	...
	(*GetDestinationURLFromShortURLRequest)(nil),  // 3: url_shortener.GetDestinationURLFromShortURLRequest
	(*GetDestinationURLFromShortURLResponse)(nil), // 4: url_shortener.GetDestinationURLFromShortURLResponse
}
var file_url_shortener_url_shortener_proto_depIdxs = []int32{
	...
	3, // 2: url_shortener.UrlShortenerService.GetDestinationURLFromShortURL:input_type -> url_shortener.GetDestinationURLFromShortURLRequest
	2, // 3: url_shortener.UrlShortenerService.CreateShortURL:output_type -> url_shortener.CreateShortURLResponse
	4, // 4: url_shortener.UrlShortenerService.GetDestinationURLFromShortURL:output_type -> url_shortener.GetDestinationURLFromShortURLResponse
...
func file_url_shortener_url_shortener_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_url_shortener_url_shortener_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDestinationURLFromShortURLRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_url_shortener_url_shortener_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDestinationURLFromShortURLResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
